...
/**
 * {@link UserReceiptDetails} represents a single Android platform release.
...
public class UserReceiptDetails {
    ...
    /*
    * Create a new UserReceiptDetails object.
    *
    * @param vName is the name of the Android version (e.g. Gingerbread)
    * @param vNumber is the corresponding Android version number (e.g. 2.3-2.7)
    * @param image is drawable reference ID that corresponds to the Android version
    * */
    public UserReceiptDetails(String vName, String vNumber, String imageResourceId)
    {
        mVersionName = vName;
